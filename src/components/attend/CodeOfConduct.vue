...
<template>
  <Card>
    ...
    <template #content>
      ...
      <p>
        Attending Fox Den Club events while not registered or having been banned may be considered trespassing and
        prosecutable by law.
      </p>
      ...
      <p>
        The issued event badge must be visible while at the event for which it was issued. This helps staff easily see
        that you are indeed a club member and therefore entitled to attend the event. You may be required to provide a
        government issued ID to enter any spaces designated for adults-only or that may involve alcohol and your face
        will need to be visible to verify your age/identity.
      </p>
      <p>
        By accepting your membership card you agree to abide by all Fox Den Club policies and to indemnify and hold
        harmless Fox Den Club from any claim for personal injuries or any other damages or equity arising out of any
      ...
      <p>
        ...
        minors under the age of 16 must be accompanied by a parent or legal guardian at all times.
      </p>
      <p>
        A minor above the age of 15 may attend the convention without a parent or guardian with a signed and notarized
        parent/guardian waiver.
      </p>
      <p>
        Minors under 12 may be able to attend for free at a basic attendee level. Contact the club prior for details.
        Any additional benefits, such as those provided at higher registration tiers, will incur a cost to be added to
        the parent/guardian’s registration.
      </p>
      <p>
        Parents/Guardians must be registered as well even if “just supervising.” No one other than the minor’s
        parent/guardian will be in any way responsible for a minor and their actions.
      </p>
      <p>
        Minors will not be permitted into any areas requiring age verification (such as 18+ or 21+) regardless of having
      ...
      <p>
        ...
        symptoms may be cause for expulsion. If you come down with something near enough to not be able to attend an
        event, please contact the club and we will try to help out in some way.
      </p>
      <p>
      ...
      <p>
        ...
        if unsure if an event will be suitable for a minor.
      </p>
      <p>
      ...
      <p>
        Attendees may not enter the service areas of any venue or event space. This includes, but is not limited to,
        backstage areas, service elevators, rooftops, emergency exits, and any areas marked “staff only.” Exceptions may
      ...
      <p>
        Play acting, mock fighting, hitting yourself, staged combat, etc. is not allowed within event space without
        prior staff approval and supervision.
      </p>
      <p>
        Attendees are required to follow any reasonable instructions when given by a staff member. If you believe an
        instruction is not reasonable, address your concerns to the Manager of that department. Disputes are escalated
      ...
      <p>
        Any act of vandalism or deliberate damage to any venue or club property will result in immediate and permanent
        removal from Fox Den Club. This also includes any interference with venue staff in the performance of their
        duties.
      </p>
      <p>
        Merchandise sales may only be performed in designated areas and only by parties who have prior arrangements with
        the club or venue to conduct business. A business license may be required by the state. It is not the
      ...
      <p>
        ...
        banning from Fox Den club.
      </p>
      <p>
        Signs may not be posted to walls or doors in venues without prior approval from Fox Den Con staff. If approved,
        you must use blue or “delicate surface” painter’s tape to help prevent residue being left on the surface, and
        have your badge name somewhere on the sign. Any damage incurred from signage, regardless of how it was attached,
        is the sole responsibility of the named renter. Members are expected to remove all signs they put up by the end
        of the event.
      </p>
      <p>
      ...
      <p>
        ...
        contact information; if it is turned in, we will contact you to arrange pickup. Items will not be shipped for
        free or held indefinitely. Though we may hold them longer, items left may be thrown away, donated, given away,
      ...
      <p>
        Unless otherwise specified, event areas and public spaces are subject to standard public decency standards. No
      ...
      <p>
        Any conduct, dress, or speech that targets, threatens, intimidates, or is otherwise intended to cause distress
        to others will not be tolerated. Please report any instances of harassment to Security.
      </p>
      <p>
        If you feel you are in immediate danger, feel free to contact event or venue security. The venue will have
        security on duty 24/7.
      </p>
      <p>
        It is the job of neither the club nor venue to solve your interpersonal problems. If you believe there is a
        legal reason a person should not be at a club event, please see security to present evidence (such as police
        reports) so we can get law enforcement involved.
      </p>
      <p>
        If someone asks you to leave them alone, leave them alone. Continuing to bother other members may lead to being
        banned and removed from events, even over digital platforms.
      </p>
      ...
      <p>Violations may result in intervention from law enforcement and banning from the club/events.</p>
      ...
      <p>
        In accordance with the ADA, recognized Service Animals are permitted. Service animals are defined as dogs that
        are individually trained to do work or perform tasks for people with disabilities. Attempting to falsely claim
        an animal as a Service Animal may result in revocation of membership and local law enforcement involvement. If a
      ...
      <p>
        ...
        staff member and may not record anything without explicit permission from the escorting staff member. Interviews
        must also be approved by whoever is being interviewed.
      </p>
      <p>
        Fox Den Club considers recorded interviews of any type performed in event spaces to be a form of media
        representation and require an approved club press pass. A press pass is not a substitute for membership and may
        require escort as determined by club staff. A press pass may be revoked at any time for any reason as determined
        by a director or chair.
      </p>
      <p>
        Please do not speak to any members of the press who do not have a press badge as their intentions may be to harm
        the fandom or club and report them to staff immediately.
      </p>
      <p>
        Photos and videos may be taken in any event space for personal use. This means they may end up on the internet
        as well. If you do not wish to be photographed, please notify the photographer immediately. We do ask that you
        respect the wishes of anyone who asks to not be photographed by not posting pictures/videos of them or blurring
        them out, though attendees should understand the club cannot reasonably enforce this if taken in event space.
      </p>
      <p>Any commercial use of photos or videos taken in event space must be approved by Fox Den Club.</p>
      <p>
        Fox Den Club staff may take photos at any of our events to document events and highlights in programming. By
        attending an event you acknowledge your likeness may be used in our marketing, social media, digital platforms,
        or zines.
      </p>
      <p>
        Unless otherwise specified, no recording of any kind is permitted of/in any area that is age restricted or in
        any headless lounge, even for members of the press.
      </p>
      <p>
        The names Fox Den Club and Fox Den Con and any associated works/logos are trademarks of Fox Den Club and must
        not be used in any fashion that disparages or dilutes that mark. Members agree to remove from circulation or
      ...
      <p>
        ...
        and may not ask for tips or payments of any kind, including having a tip box present. Generally, we prefer these
        performances to be played as events such that we may assign you a position on the schedule.
      </p>
      <p>
        Only handheld glowsticks are permitted in the dances. Poi, glowsticks on strings or poles, or any other props
        that may be dangerous during a dance event, are not allowed other than in designated areas. If you are unsure
        where that is, please ask a staff member. By entering that area you agree to accept the liability and danger
